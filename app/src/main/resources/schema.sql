...
CREATE TABLE IF NOT EXISTS HIGH_LOW_PLAYING_CONTEXT(id bigint primary key identity, game_id bigint, user_name varchar(100), start_at timestamp, target bigint, state varchar(100), score integer, version bigint, UNIQUE(game_id, user_name))
